...
<v-container>
  ...
  <v-container v-else-if="storeInfo.store_name!=null && loadingFlag==true">
    <StoreInfoComponent v-bind:storeInfo="storeInfo"></StoreInfoComponent>
...
export default {
  ...
  created() {
    axios.get("/store/tnals97").then(res => {
  ...
  methods: {
    data() {
      ...
      axios.patch("/store/tnals97").then(res => {
